...
const Upload = () => {
  return (
    <Card className="grid h-full w-full grid-cols-1 gap-3 rounded-[20px] bg-white bg-clip-border p-3 shadow-3xl shadow-shadow dark:!bg-navy-800 dark:shadow-none 2xl:grid-cols-11">
      ...
      <div className="col-span-5 flex h-full w-full flex-col justify-center overflow-hidden rounded-xl bg-white pb-4 ps-3 dark:!bg-navy-800">
