      ...
      {HistoryData.map((data, index) => (
        ...
        >
          ...
          <div className="mt-1 flex items-center justify-center text-navy-700 dark:text-white">
            ...
            <div className="ms-1 flex items-center text-sm font-bold text-navy-700 dark:text-white">
              <p> {} </p>
              {data.price} <p className="ms-1">ETH</p>
            </div>
            <div className="ms-2 flex items-center text-sm font-normal text-gray-600 dark:text-white">
              <p>{data.time}</p>
              <p className="ms-1">ago</p>
            </div>
          </div>
        </div>
      ))}
