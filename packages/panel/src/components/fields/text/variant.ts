...
export const inputTV = tv({
  ...
  compoundVariants: [
    ...
    },
    {
      disabled: false,
      severity: 'error',
      class: "border-red-500 text-red-500 placeholder:text-red-500 dark:!border-red-400 dark:!text-red-400 dark:placeholder:!text-red-400"
    },
    {
      disabled: false,
      severity: 'success',
      class: "border-green-500 text-green-500 placeholder:text-green-500 dark:!border-green-400 dark:!text-green-400 dark:placeholder:!text-green-400"
    },
  ],
  defaultVariants: {
    variant: "form",
