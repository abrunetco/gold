...
export const productDataSchema = Type.Pick(productSchema, ['email', 'password', 'googleId'], {
  $id: 'ProductData'
})
...
export const productQueryProperties = Type.Pick(productSchema, ['uid', 'email', 'googleId'])
