...
import type { GoldPrice, GoldPriceData, GoldPricePatch, GoldPriceQuery, GoldPriceService } from './class'
...
export const goldPriceMethods: Array<keyof GoldPriceService> = ['find', 'get', 'create', 'patch', 'remove']
