...
export type AccountClientService = Pick<
  AccountService<Params<AccountQuery>>,
  (typeof accountMethods)[number]
>;

export const accountPath = "accounts" as const

export const accountMethods: Array<keyof AccountService> = [
  "find",
  "get",
  "create",
  "patch",
