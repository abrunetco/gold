...
import type { Invoice, InvoiceData, InvoicePatch, InvoiceQuery, InvoiceService } from './class'
...
export const invoiceMethods: Array<keyof InvoiceService> = ['find', 'get', 'create', 'patch', 'remove']
