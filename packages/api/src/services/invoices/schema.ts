...
export const invoiceDataSchema = Type.Pick(invoiceSchema, ['email', 'password', 'googleId'], {
  $id: 'InvoiceData'
})
...
export const invoiceQueryProperties = Type.Pick(invoiceSchema, ['uid', 'email', 'googleId'])
