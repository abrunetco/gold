...
export type {
  ...
  CategoryQuery,
  CategoryPatch,
} from "./services/categories/shared";
...
export type {
  ...
  GoldPriceQuery,
  GoldPricePatch,
} from "./services/prices/gold/shared";
