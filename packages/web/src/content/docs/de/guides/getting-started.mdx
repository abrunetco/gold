...
<CardGrid>
  ...
  <Card title="Elektrosägen" icon="seti:crystal">
    Präzises Schneiden mit einstellbaren Einstellungen für verschiedene
    Materialien.
    <LinkCard title="Mehr erfahren" href="de/guides/getting-started" />
  </Card>
</CardGrid>
...
<Aside type="tip">
  Trennen Sie Werkzeuge immer vom Stromnetz, bevor Sie sie reinigen. Verwenden
  Sie ein weiches, trockenes Tuch, um die Außenseite abzuwischen und lagern Sie
